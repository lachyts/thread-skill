...
- Apart from vault tasks and any offer to create the thread file, it proposes nothing and asks no approval for memory saves or commits.
...
- It edits, marks, adds front matter to, moves or deletes the legacy doc.
